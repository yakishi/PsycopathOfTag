...
public class TrapList_importer : AssetPostprocessor
{
    private static readonly string filePath = "Assets/ExcelData/TrapList.xls";
    private static readonly string[] sheetNames = { "Trap", };
